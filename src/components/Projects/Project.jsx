...
const Project = ({ project }) => {
  ...
  return (
    ...
    >
      ...
      <div className="order-1 col-span-full flex max-h-[60vh] min-w-fit items-center justify-center overflow-hidden rounded-t-lg duration-1000 ease-out lg:order-2 lg:col-span-9 lg:col-start-4 lg:translate-x-16 lg:items-start  lg:rounded-lg xl:translate-x-0 ">
